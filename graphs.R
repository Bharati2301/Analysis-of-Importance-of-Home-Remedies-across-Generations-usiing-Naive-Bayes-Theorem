Home_Remedies <- read.csv("C:/Users/arund/OneDrive/Desktop/MU/Project/Cleaned_data.csv", stringsAsFactors=TRUE)
...
Home_Remedies2 <- read.csv("C:/Users/arund/OneDrive/Desktop/MU/Project/Age_Copy.csv", stringsAsFactors=TRUE)
